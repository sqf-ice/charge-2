...
/**
 * {@link AccessDecisionManager}在Spring security中是很重要的。
 * <p>
 ...
 * <p>
 * 从第一个方法可以看出来，{@link AccessDecisionManager}使用方法参数传递所有信息，这好像在认证评估时进行决定。
 * 特别是，在真实的安全方法期望调用的时候，传递安全Object启用那些参数。
 * 比如，让我们假设安全对象是一个MethodInvocation。
 * 很容易为任何Customer参数查询MethodInvocation，
 * 然后在{@link AccessDecisionManager}里实现一些有序的安全逻辑，来确认主体是否允许在那个客户上操作。
 * 如果访问被拒绝，实现将抛出一个AccessDeniedException异常。
 * <p>
 * 这个 supports(ConfigAttribute) 方法在启动的时候被
 * {@link org.springframework.security.access.intercept.AbstractSecurityInterceptor}调用，来决定AccessDecisionManager
...
public class CustomAccessDecisionManager implements AccessDecisionManager {
    ...
    /**
     * 主要验证方法，{@link org.springframework.security.access.intercept.AbstractSecurityInterceptor}afterInvocation方法调用
     * <br>
     * 这块的认证策略可以自定义，根据URL取不到权限，默认是公共资源，
     *
