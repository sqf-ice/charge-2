...
import com.clouyun.charge.modules.system.web.RoleController;
 ...
 * 创建日期: 2017年04月19日
 */
public class RoleControllerTests extends ApplicationTests{

    @Autowired
    private RoleController roleController;//你要测试的Controller
    ...
    public void saveRole() throws Exception {
        String roleJson = FileUtils.read("/modules/system/saveRole.json");
        System.out.println("读取到的Json文件:" + roleJson);
        //调用接口，传入添加的用户参数
        ResultActions ra = mockMvc.perform(post("/api/roles")
