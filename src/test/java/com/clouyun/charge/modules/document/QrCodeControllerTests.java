...
import com.clouyun.charge.modules.document.web.QrCodeController;
 ...
 */
public class QrCodeControllerTests extends ApplicationTests{

    @Autowired
    private QrCodeController codeController;//你要测试的Controller
    ...
    public void update() throws Exception {
        String dictJson = FileUtils.read("/modules/document/qrCode.json");
        System.out.println("读取到的Json文件:" + dictJson);
        //调用接口，传入添加的用户参数
        ResultActions ra = mockMvc.perform(put("/api/qrcodes/_hlhtIssued")
